...
public class Living extends Offer implements Serializable {
	 ...
	 */
	public Living(LocalDate startingDate, double price, RegisteredUser host, House house, double months)
			throws HostException {
	 ...
	 * @param s
	 *            New starting date of the offers
	 * @param d
	 *            New price of the offer
	 * @param months
	 *            New number of months of the offer
	...
	/**
	 * Tells if an offer is a living offer
	 * 
	 * @return true
	 */
