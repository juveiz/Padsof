...
public abstract class Profile implements Serializable {
	 ...
	 * @param o
	 *            Offer to be removed
	 * @return true if you can remove the offer or false if the offer is not in the
	 *         profile
	 */
	 ...
	 * @param h
	 *            House to be removed
	 * @return true if you can remove the house or false if the house is not in the
	 *         profile
	 */
	...
	/**
	 * Return the offers from a profile
	 * 
	 * @return null
	 */
	...
	/**
	 * Return the houses form a profile
	 * 
	 * @return null
	 */
