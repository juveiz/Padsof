...
public class ModifiableDate {
	...
	private static LocalDate modifiableDate = LocalDate.now().withDayOfMonth(1).withMonth(3).withYear(2017);

	/**
	 * This function is used to add a specific number of days to the date.
	 * 
	 * @param numDays
	 *            Number of days we want to increase
	 */
	 ...
	 * 
	 * @param day
	 *            The day for the new modifiable date
	 * @param month
	 *            The month for the modifiable date
	 * @param year
	 *            The year for the modifiable date
