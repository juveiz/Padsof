...
public class ModifyVacationalView {
	private Offer offer;
	private JFrame main;
	...
	public ModifyVacationalView(Offer offer) {
		this.offer = offer;
		main = new JFrame("Modify Vacational Offer");
		addOffer = new JLabel("Add the paramters to change the offer");
		...
		endDate = new JPanel(new FlowLayout(FlowLayout.LEFT));
